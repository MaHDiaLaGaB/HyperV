...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "asset_type",
            sa.Enum("IMAGE", "VIDEO", "GIS", name="assettype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_assets_organization_id"), "assets", ["organization_id"], unique=False
    )
    op.create_table(
        "pipelines",
        sa.Column("organization_id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "frequency",
            sa.Enum("WEEKLY", "MONTHLY", "QUARTERLY", name="reportfrequency"),
            nullable=False,
        ),
